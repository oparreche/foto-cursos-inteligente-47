...
// Using 'any' type for specific fields where type inference is problematic
...
export async function findUserByEmail(email: string): Promise<string | undefined> {
  try {
    // Execute the query first, then apply the type assertion afterward
...
export async function createUser(
  ...
  try {
    ...
    // Execute the query and destructure the response directly
