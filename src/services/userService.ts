...
export async function findUserByEmail(email: string): Promise<string | undefined> {
  try {
    // Use raw SQL query format or simplify the chain to avoid type instantiation issues
...
export async function createUser(
  ...
  try {
    ...
    // Insert profile without chaining select() to avoid type instantiation issues
